...
import { tierCheck } from "@/lib/services/tier-check";
...
export default function AddTeamMemberDialog({
  ...
  // Get the max users allowed for current tier
          ...
          <PermissionGate permission="user.invite">
            <TabsContent value="invite" className="space-y-6 mt-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {selectedRole && (
                  <div
                    className={`border-l-4 ${selectedRole.border} bg-muted/50`}
                  >
                ...
                {/* Max User Check - Enhanced Version */}
                {/* User Count Display */}
                ...
                <div className="flex gap-2 items-center justify-end">
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading || !memberData.email || isAtUserLimit}
