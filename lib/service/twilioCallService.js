...
export async function createFollowUp(leadId, callSid, from, to, reason = "voicemail") {
  try {
...
export async function createProspect(phoneNumber, callSid, source = "inbound_call") {
  try {
