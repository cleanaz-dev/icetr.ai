...
export const TIER_FEATURES = [
  ...
  },
  {
    ...
    configName: "aiCallGradingEnabled",
    icon: Star,
  ...
  },
  {
    ...
    configName: "aiLeadResearchEnabled",
    icon: Sparkles,
  ...
  },
  {
    ...
    configName: "aicoldCallingEnabled",
    icon: Globe,
    color: "text-teal-500",
    description: "AI-powered cold calling",
    category: "ai",
  },
